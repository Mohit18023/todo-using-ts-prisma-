    ...
    <div>
      <main className="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
        ...
        <button className="mt-5">
          <a className="relative inline-block text-sm font-medium text-primary-600; group active:text-primary-600; focus:outline-none focus:ring">
            ...
            <span className="relative block px-8 py-3 bg-primary-600 text-white border border-current">
